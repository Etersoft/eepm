...
subst "s|^URL:.*|URL: https://www.jetbrains.com/ruby/|" $SPEC
subst "s|^Summary:.*|Summary: RubyMine - A cross-platform IDE for Ruby and Mine|" $SPEC
...
Type=Application
Name=RubyMine
Comment=A cross-platform IDE for Ruby and Rails
Exec=$PRODUCT %f
Icon=$PRODUCT
Terminal=false
StartupNotify=true
