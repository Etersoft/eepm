...
[ ! -e "$BUILDROOT$PRODUCTDIR/blender-softwaregl" ] || add_bin_link_command blender-softwaregl $PRODUCTDIR/blender-softwaregl
...
ignore_lib_requires libamdhip64.so.6 libamdhip64.so.7 libcuda.so.1 libze_loader.so.1
