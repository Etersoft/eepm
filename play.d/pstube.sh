...
if [ "$VERSION" = "*" ] ; then
    PKGURL=$(eget --list --latest https://github.com/prateekmedia/pstube/releases "$PKGNAME-[0-9]*-$arch.$pkgtype")
else
    PKGURL="https://github.com/prateekmedia/pstube/releases/download/$VERSION/$PKGNAME-$VERSION-linux-$arch.$pkgtype"
fi
